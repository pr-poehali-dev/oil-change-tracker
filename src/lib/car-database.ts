...
export const CAR_MODELS: Record<string, string[]> = {
  "Toyota": ["Camry","Corolla","Land Cruiser","Land Cruiser Prado","Hilux Surf","Surf","RAV4","Hilux","Fortuner","Yaris","Auris","Avensis","Highlander","Sequoia","Tundra","Tacoma","4Runner","FJ Cruiser","Venza","Sienna","Alphard","Vellfire","Prius","Aqua","Passo","Ractis","Vitz","Belta","Platz","Funcargo","Raum","Sienta","Celica","Supra","MR2","MR-S","Levin","Sprinter","Sprinter Trueno","Sprinter Carib","Carina","Carina ED","Corona","Corona Premio","Chaser","Cresta","Mark II","Mark X","Verossa","Crown","Crown Majesta","Century","Wish","Ipsum","Gaia","Nadia","Opa","Estima","Estima Lucida","Previa","Verso","Corolla Verso","C-HR","Corolla Cross","Harrier","Kluger","Blade","Auris","Fielder","Axio","Runx","Allex","Will","Premio","Allion","Caldina","Cressida","Soarer","Aristo","Altezza","Brevis","Progres","Origin","Windom","Ist","Urban Cruiser","Rush","bB","Porte","Spade","Tank","Roomy","Pixis","Esquire","Noah","Voxy","Regius","Grand Hiace","Granvia","Hiace","Hiace Regius","LiteAce","TownAce","Dyna","ToyoAce","Innova","Avanza","Rush","Cami","Duet","Corolla II","Tercel","Starlet","Paseo","Sera","bZ4X","Prius Prime"],
  "Lexus": ["CT","IS","IS-F","ES","GS","GS-F","HS","LS","UX","NX","RX","GX","LX","LC","RC","RC-F","RZ","SC","LM"],
  ...
  "Nissan": ["Almera","March","Micra","Note","Tiida","Latio","Sunny","Bluebird","Bluebird Sylphy","Sylphy","Sentra","Primera","Wingroad","AD","Avenir","Expert","Pulsar","Sentra","Cube","Juke","Kicks","Teana","Maxima","Cefiro","Laurel","Skyline","Fuga","Cima","President","Stagea","Qashqai","Dualis","X-Trail","Murano","Rogue","Pathfinder","Terrano","Terra","Patrol","Safari","Navara","Frontier","Datsun","Serena","Presage","Bassara","Elgrand","Lafesta","Liberty","Prairie","Largo","Vanette","Caravan","NV200","Leaf","Ariya","GT-R","370Z","350Z","Fairlady Z","Silvia","180SX","200SX","Skyline GT-R"],
  "Mazda": ["2","3","6","Demio","Axela","Atenza","Familia","Capella","626","323","Premacy","Biante","MPV","Bongo","Verisa","Carol","Flair","Tribute","CX-3","CX-30","CX-5","CX-7","CX-8","CX-9","CX-60","MX-5","MX-30","RX-7","RX-8","BT-50","Millenia","Xedos","Roadster"],
  "Honda": ["Jazz","Fit","Fit Shuttle","Shuttle","City","Civic","Civic Ferio","Civic Type R","Integra","Accord","Accord Wagon","Torneo","Inspire","Saber","Ascot","Rafaga","Vigor","Domani","Airwave","Partner","Prelude","CR-V","HR-V","Vezel","ZR-V","WR-V","BR-V","UR-V","Avancier","Pilot","Passport","Ridgeline","FR-V","Edix","Element","CR-Z","Insight","Legend","Odyssey","Elysion","Lagreat","Stream","Stepwgn","Freed","Mobilio","Spike","Capa","Logo","Life","Zest","That's","N-Box","N-One","N-WGN","N-Van","S660","S2000","Beat","NSX","e"],
  ...
  "ГАЗ": ["Газель","Газель Next","Газель БИЗНЕС","Газель NN","Соболь","Валдай","ГАЗон Next","Садко Next","3302","2705","Волга 3110","Волга 31105"],
  "GAZ": ["Gazelle","Gazelle Next","Sobol","Valdai","Gazon Next","Sadko Next"],
  "КАМАЗ": ["5490","5320","43118","65115","65117","6520","4308","65208","Компас","54901"],
  "КамАЗ": ["5490","5320","43118","65115","65117","6520","4308","65208","Компас","54901"],
  "Москвич": ["2140","412","408","2141","3","5"],
  "Mitsubishi": ["Colt","Mirage","Lancer","Lancer Evolution","Lancer Cedia","Galant","Galant Fortis","Emeraude","Diamante","Carisma","Sigma","Legnum","Aspire","Attrage","Xpander","Outlander","Outlander Sport","Airtrek","ASX","RVR","Eclipse Cross","Eclipse","Pajero","Pajero Sport","Pajero Mini","Pajero iO","Montero","Challenger","L200","Triton","L300","Delica","Delica D:5","Chariot","Grandis","Space Star","Space Wagon","Space Gear","Dion","Toppo","eK","i-MiEV","FTO","GTO","3000GT","Minica","Town Box"],
  "Subaru": ["Impreza","Impreza WRX","WRX","WRX STI","Legacy","Legacy B4","Legacy Lancaster","Outback","Forester","XV","Crosstrek","BRZ","SVX","Tribeca","Exiga","Levorg","Ascent","Justy","Vivio","Pleo","Stella","R2","Sambar","Domingo","Traviq","Baja","Solterra","Dias"],
  "Daihatsu": ["Terios","Terios Kid","Sirion","YRV","Materia","Cuore","Mira","Mira Gino","Move","Move Conte","Tanto","Boon","Bego","Rocky","Copen","Hijet","Atrai","Charade","Applause","Storia","Naked","Esse","Wake","Cast","Rugger","Feroza","Delta"],
  ...
  "Suzuki": ["Alto","Wagon R","Swift","Cultus","Ignis","Splash","Baleno","Celerio","Aerio","SX4","SX4 S-Cross","S-Cross","Vitara","Escudo","Grand Vitara","Grand Escudo","XL-7","Jimny","Samurai","Sidekick","Ertiga","XL6","Kizashi","Liana","Every","Carry","Spacia","Solio","Hustler","Lapin","Palette","Landy","Kei","MR Wagon","Twin"],
